      ...
      <View style={{
        ...
        <View style={{
          ...
          <TouchableOpacity style={{
            ...
            <Icon name="dots-vertical" size={RFPercentage(4)} color={Colors.ColorWhite()} />
          </TouchableOpacity>
          <View style={{
            backgroundColor: Colors.ColorPrimary(),
            borderRadius: 100,
            ...
            <Icon name="account" size={RFPercentage(10)} color={Colors.ColorWhite()} />
          </View>
          <Text style={{
            color: Colors.ColorWhite(),
          ...
          <View style={{
            ...
            <TouchableOpacity style={{
              ...
              <View style={{
                ...
                <Icon name="receipt" size={RFPercentage(3)} color={Colors.ColorBlack()} />
              </View>
              <Text style={{
                color:Colors.ColorBlack(),
              ...
              <Icon style={{
                ...
                right:0,
                top:RFPercentage(2)
              }} name="chevron-right" size={RFPercentage(5)} color={Colors.ColorBlack()} />
            </TouchableOpacity>
